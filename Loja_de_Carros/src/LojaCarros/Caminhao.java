...
public class Caminhao extends Veiculo{
    ...
    public Caminhao(String marca, String modelo, int anoFabrico, int potencia, int cilindrada,  double consumo, double capacidadeCarga) {
        super(marca, modelo, anoFabrico, potencia, cilindrada, TipoCombustivel.DIESEL, consumo);
        this.capacidadeCarga = capacidadeCarga;
    }

    public Caminhao(String marca, String modelo, int anoFabrico, int potencia, int cilindrada, TipoCombustivel tipoCombustivel, double consumo) {
